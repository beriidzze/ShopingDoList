...
document.addEventListener("DOMContentLoaded", function () {
  loadItems();
  updateState();
  shoppingForm.addEventListener("submit", handlerFormSubmit);
  for (let button of filterButtons) {
    button.addEventListener("click", handlerFilterSelection);
  }
...
function addItem(input) {
  ...
  shoppingList.prepend(newItem); //appendChild listenin en ustune eklenir
...
function handlerFilterSelection(e) {
